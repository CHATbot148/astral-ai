export type VideoModelId = "pollinations_grok_video_pro" | "pollinations_veo" | "pollinations_seedance_pro" | "pollinations_seedance_2" | "pollinations_wan_pro" | "pollinations_ltx_2" | "pollinations_nova_reel" | "puter_sora_2_pro" | "puter_veo_31_lite";
...
export const VIDEO_MODEL_OPTIONS: VideoModelOption[] = [
  {
    value: "pollinations_grok_video_pro",
  ...
  },
  {
    ...
    label: "Veo",
    hint: "Pollinations · Veo 3.1 Fast",
    provider: "pollinations",
    durations: [4, 6, 8] as VideoDurationOption[],
    qualities: ["720p", "1080p"],
    supportsImageRef: true,
  ...
  {
    value: "pollinations_seedance_2",
    label: "Seedance 2.0",
    hint: "Pollinations · video + audio",
    provider: "pollinations",
    durations: [5, 8, 10] as VideoDurationOption[],
    qualities: ["720p", "1080p"],
    supportsImageRef: true,
  ...
  {
    value: "pollinations_ltx_2",
    label: "LTX 2.3",
    hint: "Pollinations · sharp motion",
    provider: "pollinations",
    durations: [4, 6, 8] as VideoDurationOption[],
    qualities: ["720p", "1080p"],
    supportsImageRef: true,
  ...
  {
    value: "pollinations_nova_reel",
    label: "Nova Reel",
    hint: "Pollinations · fast fallback",
    provider: "pollinations",
    durations: [4, 6] as VideoDurationOption[],
    qualities: ["720p", "1080p"],
    supportsImageRef: true,
  },
  {
...
export const DEFAULT_VIDEO_MODEL_ID: VideoModelId = "pollinations_grok_video_pro";
